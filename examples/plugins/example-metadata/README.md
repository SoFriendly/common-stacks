...
A minimal Common Stacks plugin written as a Python script. No compilation, no
toolchain — copy the folder, restart, done.

## Install

1. In Common Stacks, open **Settings → Plugins → Open plugins folder**.
...
provides, and `plugin.py` implementing it. Common Stacks calls
